...
var jsxRuntimeExports$1 = requireJsxRuntime();
var react = { exports: {} };
...
const root1 = clientExports.createRoot(document.getElementById("calendar-demo-1"));
root1.render(
...
const root2 = clientExports.createRoot(document.getElementById("calendar-demo-2"));
root2.render(
  /* @__PURE__ */ jsxRuntimeExports$1.jsx(
    Calendar,
    {
      fetchEvents: async (startDate, endDate) => {
        ...
        return [
          { start: /* @__PURE__ */ new Date(), title: "Event sample", slug: "event-sample" }
        ];
      },
      createEvent: async () => {
      },
